...
namespace BaseDatos_ElCorteCheco
{
    public partial class Form1 : Form
    {
        ...
        /*
         * Métodos para que no se pueda CORTAR/PEGAR elementos en el cuadro del Identificador.
         */
        private void textElec1_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Control == true)
            {
                MessageBox.Show("No es posible cortar/pegar en la casilla del Identificador.", "Error al cortar/pegar en el cuadro de texto", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

        private void textJuego1_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Control == true)
            {
                MessageBox.Show("No es posible cortar/pegar en la casilla del Identificador.", "Error al cortar/pegar en el cuadro de texto", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void textModa1_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Control == true)
            {
                MessageBox.Show("No es posible cortar/pegar en la casilla del Identificador.", "Error al cortar/pegar en el cuadro de texto", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        /*
         * Métodos para que no se pueda CORTAR/PEGAR elementos en el cuadro de precio.
         */
        private void textElec4_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Control == true)  
            {
                MessageBox.Show("No es posible cortar/pegar en la casilla del Precio.", "Error al cortar/pegar en el cuadro de texto", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

        private void textJuego4_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Control == true)
            {
                MessageBox.Show("No es posible cortar/pegar en la casilla del Precio.", "Error al cortar/pegar en el cuadro de texto", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void textModa4_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Control == true)
            {
                MessageBox.Show("No es posible cortar/pegar en la casilla del Precio.", "Error al cortar/pegar en el cuadro de texto", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void consultarElec_Click(object sender, EventArgs e)
        {
            ...
            if (registros.Read())
            {
                ...
                SqlConnection conexion2 = new SqlConnection("server = PC-FERNANDO\\SQLEXPRESS ; database = elcortecheco ; integrated security = true");
                ...
                {
                    //Comprobamos si hemos obtenido una imagen
